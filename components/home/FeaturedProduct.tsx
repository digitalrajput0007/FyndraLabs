...
import { ArrowRight, Receipt, Sparkles, Scale, Users, UserPlus, FolderKanban } from "lucide-react";
...
export function FeaturedProduct() {
  ...
  return (
    <section className="py-16 lg:py-24 bg-slate-50/70 dark:bg-[#080c14] border-y border-slate-200/80 dark:border-slate-800/80 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* Featured SplitMate Box */}
        <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-6 sm:p-10 shadow-xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6 space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-xs font-mono font-semibold text-brand-600 dark:text-brand-400 uppercase tracking-wider block">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                {featureIcons.map((item, idx) => {
                  ...
                  return (
                    <div key={idx} className="flex items-start gap-2.5 p-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800/60">
                      <div className="w-6 h-6 rounded-lg bg-brand-500/10 text-brand-500 flex items-center justify-center shrink-0 mt-0.5">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-brand-600 hover:bg-brand-700 text-white font-semibold text-sm shadow-md transition-all duration-200"
                >
