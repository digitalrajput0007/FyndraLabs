                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 rounded-xl bg-white dark:bg-slate-950 border text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-500 transition-colors ${
                          errors.name
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-slate-900 text-white border border-slate-800 space-y-5 shadow-md">
                ...
                <div>
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-brand-300 font-semibold text-sm border border-slate-700 transition-colors w-full justify-center"
                  >
